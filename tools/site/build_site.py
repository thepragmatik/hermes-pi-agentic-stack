...
def render_md(text: str, page: str) -> str:
    ...
    def close_table():
        nonlocal table
        if table:out.append('<pre class="md-table">'+html.escape("\n".join(table))+"</pre>");table=[]
